...
plot_change_deaths <- function(country) {
  ...
  plot <- ggplot(country_set.new_by_week, mapping = aes(Deaths, new_deaths_by_week)) + geom_line() + labs(title='Trajectory of Deaths', y='New Deaths (past week)', x='Total Deaths')
  return(plot)
}
...
plot_change_confirmed <- function(country) {
  ...
  plot <- ggplot(country_set.new_by_week, mapping = aes(Confirmed, new_confirmed_by_week)) + geom_line() + labs(title='Trajectory of Confirmed Cases', y='New Confirmed Cases (past week)', x='Total Confirmed Cases')
  return(plot)
}
